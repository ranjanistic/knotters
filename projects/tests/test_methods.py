...
from .utils import TEST_PROJ_NAME, TEST_PROJ_REPO, TEST_CATEGORY, TEST_DESC, TEST_TAG, getTestTags
...
class ProjectsMethodTest(TestCase):
    ...
    def test_createProject(self):
        self.assertIsInstance(createProject(TEST_PROJ_NAME, TEST_CATEGORY, TEST_PROJ_REPO, TEST_DESC, getTestTags(3), self.creator), Project)
        pass

    def test_setupApprovedProject(self):
        project = createProject(TEST_PROJ_NAME, TEST_CATEGORY, TEST_PROJ_REPO, TEST_DESC, getTestTags(3), self.creator)
