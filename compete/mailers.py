...
def participantWelcomeAlert(profile: Profile, submission: Submission) -> bool:
    ...
    return sendActionEmail(
        ...
        conclusion=f"You recieved this email because you participated in a competition at {PUBNAME}. If this is unexpected, please report to us by replying to this email."
    )
