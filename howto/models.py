...
class Lesson(models.Model):
    ...
    topics = models.ManyToManyField(Topic, through='LessonTopic', default=[], related_name='lesson_topics')
...
class Course(models.Model):
    ...
    desc_long=models.CharField(max_length=250)
    author=models.ForeignKey(Profile,related_name="courses",on_delete=models.CASCADE)
    def __str__(self) -> str:
        return super().__str__()
...
class LessonTopic(models.Model):
    ...
    topic: Topic = models.ForeignKey(Topic, on_delete=models.CASCADE, related_name='lesson_topic')
    lesson:Lesson=models.ForeignKey(Lesson, on_delete=models.CASCADE, related_name='topic_lesson')
