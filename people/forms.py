...
class CustomSignupForm(SignupForm):
    first_name = forms.CharField(max_length=70, label='Your Name',help_text="Your Name",widget=forms.TextInput(attrs={'placeholder': 'Your Name', 'autocomplete': 'name', 'type':'text', 'class':'required-field'}))
